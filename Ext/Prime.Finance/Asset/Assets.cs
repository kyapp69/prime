...
namespace Prime.Finance
{
    public class Assets
    {
        ...
        public IReadOnlyList<Asset> Popular => _popular ?? (_popular = "BTC,ETH,XRP,LTC,USD,EUR,JPY,USDT,KRW".ToAssetsCsvRaw());
        ...
        public Asset GetRaw(string assetCode)
        {
            ...
            if (!contains)
                DefaultMessenger.I.Instance.Send(new AssetFoundMessage(a));
