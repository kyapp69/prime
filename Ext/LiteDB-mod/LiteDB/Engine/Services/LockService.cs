    ...
    public class LockService
    {
        ...
        private Action LockReserved()
        {
            lock(_disk)
            {
                ...
                _log.Write(LoggerWrap.LOCK, "entered in reserved lock mode");
                ...
                return () =>
                {
                    ...
                    _log.Write(LoggerWrap.LOCK, "exited reserved lock mode");
                };
            }
        }
        ...
        private Action LockExclusive()
        {
            lock (_disk)
            {
                ...
                _log.Write(LoggerWrap.LOCK, "entered in exclusive lock mode");
                ...
                return () =>
                {
                    ...
                    _log.Write(LoggerWrap.LOCK, "exited exclusive lock mode");
                    ...
                    if (_shared)
                    {
                        ...
                        _log.Write(LoggerWrap.LOCK, "backed to shared mode");
                    }
                };
            }
        }
        ...
        private void AvoidDirtyRead()
        {
            ...
            _log.Write(LoggerWrap.CACHE, "checking disk to avoid dirty read");
            ...
            {
                _log.Write(LoggerWrap.CACHE, "file changed from another process, cleaning all cache pages");
