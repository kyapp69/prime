...
namespace Prime.Core
{
    public class PackageCoordinator
    {
        ...
        public PackageCoordinator(PrimeContext c)
        {
            C = c;
            PackagesDir = c.FileSystem.PackageDirectory;
            Distribution = new Packages(this, c.FileSystem.DistributionDirectory);
            Installed = new Packages(this, c.FileSystem.InstallDirectory);
        }
