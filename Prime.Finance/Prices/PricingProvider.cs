...
namespace Prime.Finance
{
    public class PricingProvider
    {
        ...
        {
            var provs = network.GetProviders<IPublicPricingProvider>().Where(x => x.PricingFeatures?.HasBulk == true && x.PricingFeatures.Bulk.CanReturnAll);
        ...
        public Task<MarketPrices> GetTask(Network network, IEnumerable<AssetPair> pairs, PricingProviderContext context = null)
        {
            ...
            var provs = network.GetProviders<IPublicPricingProvider>().Where(x=>x.PricingFeatures?.HasBulk == true).AsEnumerable();
        ...
        {
            var provs = network.GetProviders<IPublicPricingProvider>().AsEnumerable();
