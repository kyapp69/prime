...
namespace Prime.Finance
{
    internal class AssetPairProvider
    {
        ...
        public async Task<IReadOnlyDictionary<Network, AssetPairs>> GetNetworksDiskAsync()
        {
            ...
            var q = Networks.I.GetProviders<IAssetPairsProvider>().Where(x => x.IsDirect);
        ...
        {
            var q = onlyDirect ? Networks.I.GetProviders<IAssetPairsProvider>().Where(x => x.IsDirect) : (IEnumerable<INetworkProvider>)Networks.I.GetProviders<IAssetPairsProvider>();
        ...
        public async Task<IReadOnlyList<AssetPair>> GetPairsAsync(bool onlyDirect = true)
        {
            ...
            var q = onlyDirect ? Networks.I.GetProviders<IAssetPairsProvider>().Where(x => x.IsDirect) : Networks.I.GetProviders<IAssetPairsProvider>();
