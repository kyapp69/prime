...
namespace Prime.Scratch.Socket
{
    public class SocketServerTest : TestClientServerBase
    {
        public SocketServerTest(PrimeContext serverContext, PrimeContext c) : base(serverContext, c) { }
        ...
        public void SendAsClient(Server server, IMessenger msgr, BaseTransportMessage msg)
        {
            ...
            var settings = new JsonSerializerSettings()
            {
                ...
                SerializationBinder = new MessageTypeNameSerializationBinder(PrimeContext.Testing)
            };
